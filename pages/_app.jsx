...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/V6mutRf5Ye",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1013414102716129281&permissions=8&scope=bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1013414102716129281",
    },
    {
      link: true,
      name: "Partners",
