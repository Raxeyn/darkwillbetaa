                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Darkwill Beta Bot</p>
                            </div>
...
<a href="https://top.gg/bot/1013414102716129281">
  <img src={"https://top.gg/bot/1013414102716129281"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/1013414102716129281">
  <img src={"https://top.gg/bot/1013414102716129281"}/>
...
<a href="https://top.gg/bot/1013414102716129281">
  <img src={"https://top.gg/bot/1013414102716129281"}/>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/V6mutRf5Ye" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                                <a href="https://discord.com/oauth2/authorize?client_id=1013414102716129281&permissions=8&scope=bot" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://www.instagram.com/34taha_edits77/">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    <i className={`fa-brands fa-github`} /> İnstagram 
                                    </a>
                                </Link>
                            </div>
                            <div>
                                <Link href="https://youtube.com/Raxeyn">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Darkwill Beta Bot
                        </p>
